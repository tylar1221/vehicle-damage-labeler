...
FIXED_FOLDER_ID = "1xW44N0s4moCUFfD2Q4Vz6tr7gYp9M6BE"
...
# SUPABASE CONFIG
# =============================
SUPABASE_URL = "https://vlvlinfktostbnqghjqf.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZsdmxpbmZrdG9zdGJucWdoanFmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg0ODk3MjcsImV4cCI6MjA4NDA2NTcyN30.tc14gFyEN73XFMl8kcyAA71-seOGSMsqOIxHCosLrew"
...
with tab1:
    ...
    with col2:
        ...
        if save_clicked:
            if label.strip():
                # Use current_side, defaults to "none" if not selected
                save_label(
                    st.session_state.current_name, 
                    label.strip(), 
